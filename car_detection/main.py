...
from yolo_utils import scale_boxes, read_anchors, read_classes, preprocess_image, generate_colors, draw_boxes
...
def main():
    ...
    out_scores, out_boxes, out_classes = predict(sess, "0099.jpg", yolo_model, scores, boxes, classes,
                                                 class_names)

    out_scores, out_boxes, out_classes = predict(sess, "test.jpg", yolo_model, scores, boxes, classes,
                                                 class_names)


def test():
    # test yolo_filter_boxes
...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold=.6):
    ...
    # box_class_scores = box_scores[:, :, :, box_classes]  # (19, 19, 5, 1)
    ...
    # boxes = boxes[filtering_mask * ones(boxes.shape).astype(bool)].reshape((-1, 4))
