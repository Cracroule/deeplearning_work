...
def main():
    ...
    # easier version below, without data augmentation
    ...
    error_analysis(X_val, Y_true, Y_val_pred, Y_pred_classes)
...
def error_analysis(X_val, Y_true, Y_val_pred, Y_pred_classes):
